...
もし「A」なら、最も即効性があるのは車選びドットコムの掲載写真の改善です。
...
まず数字を教えてください。経営判断を先に出します。`
    ...
    if (q.includes("広告") || q.includes("車選び") || q.includes("掲載")) {
...
数字を教えてください。具体的なアクションを出します。`
    ...
    if (q.includes("何から") || q.includes("わからない") || q.includes("始め")) {
      return `何から始めればいいかわからない。大丈夫です。一緒��整理しま��ょう。
...
- 車選びドットコムの掲載写真を全車確認。15枚未満は20枚以上に増やす
...
お金が危険なら、どんなに良��施策でも「今はやらない」が正解です。
