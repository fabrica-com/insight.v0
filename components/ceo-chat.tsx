...
まず上の3つを教えてください。判断を出します。`
    ...
    if (q.includes("人") || q.includes("雇") || q.includes("スタッフ") || q.includes("採用")) {
      return `人を雇いたい。わかりました。

まず確認させてください。

1. 今の月販台数は何台ですか？
2. 「忙しすぎる」「売上を伸ばしたい」「接客の質を上げたい」のどれが一番の理由ですか？
